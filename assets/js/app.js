...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.add-to-cart', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#addedCartMsg").fadeIn(300);
  setTimeout(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#addedCartMsg").fadeOut(300);
  }, 1200);
});
setTimeout(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', 'input[type="radio"]', function () {
      // $('input[type="radio"]').click(function() {
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('id') == 'inputDeliveryNP') {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#deliveryNP').show(500).prop('required', true);
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#deliveryNP').hide(500).removeAttr('required');
      }

      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('id') == 'inputDeliveryAddress') {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#deliveryAddress').show(500).prop('required', true);
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#deliveryAddress').hide(500).removeAttr('required');
      }
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#checkout > .button").hover(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#cartView").fadeIn(300);
    }, function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#cartView").fadeOut(300);
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sort-btn").click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("i", this).toggleClass('fa-sort-amount-down-alt fa-sort-amount-down');
    });
  });
}, 1200);
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#thankyou-close').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#thankyou_message').css("display", "none");
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#gform').css("display", "block"); // resetNonNg();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#frameOrder .close-button').click(function () {
  resetNonNg();
});

function resetNonNg() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#gform').find('input:text, input:password, input:file, select, textarea').val('');
}
